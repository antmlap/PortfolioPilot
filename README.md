...
**Multi-agent stock discussion tool** — Get debate-style discussion from AI personas of famous investors (Buffett, Lynch, Dalio, Graham, Cathie Wood) with real-time sentiment and historical sentiment-vs-performance metrics. Not financial advice.

## Features

- **Discussion panel**: Warren Buffett, Peter Lynch, Ray Dalio, Benjamin Graham, and Cathie Wood as distinct AI personas with their real-world philosophies.
